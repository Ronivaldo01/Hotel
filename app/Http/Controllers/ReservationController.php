...
class ReservationController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $request->request->add(['user_id' => $user_id]);// Create the request
      Reservation::create($request->all());return redirect('dashboard/reservations')->with('success', 'Reservation created!');
    }
